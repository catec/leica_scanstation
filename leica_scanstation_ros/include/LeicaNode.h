...
public:
     ...
     * @param[in] event_msg 
     */
    static void publishEventerInfo(ros::Publisher pub, 
     ...
     * @param[in] image_msg 
     */
    static void publishVideoImage(ros::Publisher pub, 
     ...
     * 
     */
    bool connectCb(std_srvs::Trigger::Request &req, 
     ...
     * 
     */
    bool disconnectCb(std_srvs::Trigger::Request &req, 
                      std_srvs::Trigger::Response &res);
     ...
     * 
     */
    bool moveCb(leica_scanstation_msgs::MotorPose::Request &req, 
     ...
     * 
     */
    bool scanCb(leica_scanstation_msgs::Scan::Request &req, 
     ...
     * 
     */
    bool pauseCb(std_srvs::Trigger::Request &req, 
                 std_srvs::Trigger::Response &res);
     ...
     * 
     */
    bool resumeCb(std_srvs::Trigger::Request &req, 
                  std_srvs::Trigger::Response &res);
     ...
     * 
     */
    bool tiltCb(std_srvs::SetBool::Request &req, 
